...
async function sendSMS(phoneNumber, parentName) {
  const text = `${debug ? 'teste - ' : ''}StarDancers_dance_studio, lembra que o vencimento da mensalidade terminou ontem. O Contacto serve para lembrar a regularização da mesma.
