...
const text = `${debug ? 'teste - ' : ''}StarDancers_dance_studio, lembra que o vencimento da mensalidade termina hoje. O Contacto serve para lembrar a regularização da mesma.
